#
#  Be sure to run `pod spec lint DMSelectPickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of DMSelectPickerView in Markdown format.
  ...
  s.homepage     = "https://github.com/caojun/DMSelectPickerView"
